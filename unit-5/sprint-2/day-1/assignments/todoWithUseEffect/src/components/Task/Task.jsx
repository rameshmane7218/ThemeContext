...
const Task = ({data,removeItem,handleDoneStatus,handleCounter}) => {
  ...
  return (
    <li data-cy="task" className={styles.task} onMouseOver={displayBtn} onMouseLeave={hideBtn}>
      <div className={styles.taskInfo}>
        <input type="checkbox" defaultChecked={data.done} data-cy="task-checkbox" onChange={()=>handleDoneStatus(data.id,data.done)} />
      ...
      <div className={styles.taskCounter}>
        {/* Counter here */}
        <Counter data={data} handleCounter={handleCounter}/>
