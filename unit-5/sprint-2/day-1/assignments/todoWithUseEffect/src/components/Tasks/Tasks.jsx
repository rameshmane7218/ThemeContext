...
const Tasks = ({data,removeItem,handleDoneStatus,handleCounter}) => {
  ...
  return (
    <div className={styles.taskApp}>
      <ul data-cy="tasks" className={styles.tasks}>
        {/* Task List */}
        {data.map((task)=>(
          <Task key={task.id} data={task} removeItem={removeItem} handleDoneStatus={handleDoneStatus}  handleCounter={handleCounter} />
        ))}
      </ul>
