  ...
  return (
    <div className={styles.fromDiv}>
      ...
      <form onSubmit={handleOnSubmit}>
        <input data-cy="login-email" type='text' name="email" value={formData.email} onChange={handleOnChange}/>
        <input data-cy="login-password" type='password' name="password" value={formData.password} onChange={handleOnChange}/>
